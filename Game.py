...
class Game:
    ...
    def spring_stage(self):
        ...
        # 아이템, 적의 위치 초기화
        item_positions = [[random.randint(0, 240), random.randint(0, 240)] for _ in range(10)]
        enemy_positions = [[random.randint(0, 240), random.randint(0, 240)] for _ in range(5)]
        ...
        # 적 생성
        enemies = [Enemy(random.randint(0, 240), random.randint(0, 240), 5, "butterfly", self.image_loader) for _ in range(5)]
        # 타이머 설정
